...
public class ProductEditActivity extends AppCompatActivity {
    ...
    TextInputEditText textInputPrice;
    Bundle arguments;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputName.setText(arguments.get("name").toString());
        textInputPrice.setText(arguments.get("price").toString());
        int i = (int) (new Date().getTime() / 1000);
        String url = Urls.BASE + "/images/" + arguments.get("image").toString() + "?=data" + i;
    ...
    public void EditProduct(View view) {
        ...
        if (textFieldName.getError() == null && textFieldPrice.getError() == null) {
            ...
            model.setId(Integer.parseInt(arguments.get("id").toString()));
